...
sub getDefinition {
  return [[
    ...
    "CREATE UNIQUE INDEX %prefix%idx_unique_mentions ON %prefix%mentions (wikiName, mentionedBy, web, topic)",
    ...
    "ALTER TABLE %prefix%mentions ADD part VARCHAR(255) NOT NULL",
  ], [
